...
export const explorer = {
  ...
  modes: [
    { id: "full", label: "Full graph", desc: "Every note and every typed relationship.", edges: "*" },
    { id: "tree", label: "Containment", desc: "What is part of what, drawn as a tree.", edges: ["Part of"], tree: "Part of" },
  ],
}
